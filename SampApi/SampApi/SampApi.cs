...
namespace GtaSampApi
{
    ...
    {
        #region GTA SA
        private const int ADDR_PLAYER_IN_MENU = 0xBA67A4; // Is player in ESC menu (boolean)
        private const int ADDR_CURRENT_INTERIOR_ID = 0xA4ACE8; // Id of player's current interior (int)
        private const int ADDR_CURRENT_VEHICLE_ID = 0xBA18FC; // Id of player's current vehicle (int)

        private const int ADDR_CPED_PTR = 0xB6F5F0; // A 4-bytes pointer to where the ped struct is stored
        private const int PED_FACING_ANGLE_OFFSET = 0x558; // Offset from ADDR_CPED_PTR to player's facing angle

        // Player coordinates (x, y, z floats that form a 3D vector)
        ...
        #region SAMP
        // Addresses (relative to SAMP base address)
        // The memory address to which you write the message you want to display
        ...
        // Functions (relative to SAMP base address)
        // The memory address of the function that causes the message you want to display to be added to the chat
        private static readonly int[] FUNC_SAMP_ADDTOCHATWND = { 0x64520, 0x645F0, 0x67B60 };
        // The memory addresses of the functions that send the input to the server
        ...
        private static List<Zone> _zones; // All regions go here (e.g. Commerce, Rodeo...)
        private static List<Zone> _cities; // All cities go here (e.g. LS, SF...)
        ...
        /// <returns>Degrees. Value ranges from -180 to +180</returns>
        ...
        /// <summary>
        /// Adds a message to the user's chat
        /// </summary>
        ...
        /// <summary>
        /// Sends the given text as if the user had sent it. Also works with commands
        /// </summary>
        ...
        /// <summary>
        /// Is the user currently using the chat box or a dialog?
        /// </summary>
